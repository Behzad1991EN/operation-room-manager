...
Source: [Shared scheduling discussion](https://chatgpt.com/share/6aace53f-6314-83eb-864a-216a1bb0ecad), read on 18 September 2026. The confirmed corrections are implemented as rules version 2. See [business-rules.md](business-rules.md) for the active specification.
...
- Prefer at most one fixed shift per employee per day, regardless of radiation benefit. If necessary to fill coverage, allow at most two fixed shifts only for employees with 0–4 years of service. This replaces the original radiation-based same-day pair permissions.
...
Senior single holiday shifts are tried before junior double shifts. Confirmed by the user in this project on 18 September 2026.
